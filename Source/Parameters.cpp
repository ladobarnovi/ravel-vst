...
namespace
{
    ...
    // Every CC lane starts as sixteen steps of zero: a flat pattern, which is a blank
...
juce::AudioProcessorValueTreeState::ParameterLayout createParameterLayout()
{
    ...
    // designed around, so it is what a fresh instance should do. Turning it off collapses
    // the output onto the single Note Channel below, for instruments that cannot speak MPE.
    layout.add (std::make_unique<juce::AudioParameterBool> (
